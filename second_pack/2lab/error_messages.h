...
// Макросы для сообщений об ошибках для macOS
#ifdef __APPLE__
...
// Макросы для сообщений об ошибках для Linux
#ifdef __linux__
#define ERROR_MESSAGES \
    "Success",                                      /* 0 */ \
    "Operation not permitted",                      /* 1 */ \
...
#define MAX_ERROR_NUM 131
#endif

// Если не определена ОС, используем базовый набор
